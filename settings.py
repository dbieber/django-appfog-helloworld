...
# TODO: When ready, set DEBUG to False
DEBUG = True
...
using_production_settings = False
if 'VCAP_SERVICES' in os.environ:
    import json
    vcap_services = json.loads(os.environ['VCAP_SERVICES'])
    # XXX: avoid hardcoding here
    if 'mysql-5.1' in vcap_services:
        ...
        using_production_settings = True
...
# TODO: Set the timezone appropriately.
...
# TODO: Update list of installed apps if you rename app_name.
INSTALLED_APPS = (
    'django.contrib.auth',
